...
export default function AccountStatementTable() {
  ...
  useEffect(() => {
    if (accountNo) {
      axios.get(`${config.url}/bank/admin/alltransactions`, {
        headers: {
      ...
      console.error('Account number is missing in session storage');
    }
  }, [accountNo, token]);
  ...
  useEffect(() => {
    const filtered = rows.filter(row =>
      ...
      row.senderAccountNo?.toLowerCase().includes(searchTerm) ||
          ...
          <Table stickyHeader aria-label="sticky table">
            <TableHead>
              <TableRow>
                ...
                <TableCell align='center'>Receiver Account No</TableCell>
                <TableCell align='center'>Sender Account No</TableCell>
                <TableCell align='center'>Balance</TableCell>
               
                <TableCell align='center'>Transaction Payment ID</TableCell>
